...
const Review = () => {
  return (
    <Container className='review' maxWidth='lg'>
        <Stack className='stackreview' spacing={'2'}>
            ...
            <Stack className='stack1review' direction={'row'}>
                <Stack className='stack2review' spacing={2}>
                    <p className="forname">for Sony Alpha Mirrorless 4K Video Camera (Body Only)</p>
                    <Stack className='bothreview flex' direction={'row'} spacing={1} >
                        <Star className='iconstar'/>
                        <p className="starview h2 medium ">4.6</p>
                        <p className="view5 ">/ 5.0</p>
                    </Stack>
                    <p className="h81">Recommended</p>
                    <p className="forname">(88%) Buyer recommended this product</p>
                </Stack>
                <Stack className='stack3review' spacing={2}>
                    <Stack direction={'row'} spacing={2}>
                        <p  className='h81'>5.0 </p>
                        <Rating name="read-only" value={5} readOnly />
                        <p className="quantitystar h81 dark-lighter5a">1.5k</p>
                    </Stack>
                    <Stack direction={'row'} spacing={2}>
